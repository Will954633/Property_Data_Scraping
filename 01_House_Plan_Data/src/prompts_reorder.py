"""
Prompts for GPT photo reordering API calls.
"""

PHOTO_REORDER_PROMPT = """
You are a real estate photography expert specializing in creating virtual property tours.
...
Return your analysis as valid JSON with the following structure:
{
  "photo_tour_order": [
    {
      "reorder_position": 1,
      "image_index": <original index from image_analysis>,
      "url": "<image url>",
